 ...
 *
 *  Operations :
 *      reads the AE circular data pointer holding pairs of debug
 *      data+timestamps, and store the pairs in linear addressing to the
 *      parameter pointer. Stops the copy when the max parameter is reached
