...
static struct omap_clk omap44xx_clks[] = {
	...
	/*
	 * XXX I think duplicate entry with different name should be ok,
	 * since there is no initialization/setup for this timer
	 */
	CLK("omap-32k-sync-timer", "ick",	&sys_32k_ck,	CK_443X),
