...
struct audio_client {
	...
	void (*playback_eos_cb)(void *data);
	void *playback_eos_data;
	void (*playback_buf_done_cb)(void *data);
	void *playback_buf_done_data;

	void (*capture_eos_cb)(void *data);
	void *capture_eos_data;
	void (*capture_buf_done_cb)(void *data);
	void *capture_buf_done_data;
};
